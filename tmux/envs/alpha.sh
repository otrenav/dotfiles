...
tmux send-keys -t $S:3 "cd ~/code/ggstr/alpha/svc-sim" Enter
tmux_env_python $S 3
...
tmux send-keys -t $S:5 "cd ~/code/ggstr/alpha/svc-data" Enter
tmux_env_python $S 5
...
tmux send-keys -t $S:7 "cd ~/code/ggstr/alpha/svc-app" Enter
tmux_env_python $S 7

tmux new-window -t $S -a -n emacs
tmux send-keys -t $S:8 "cd ~/code/ggstr/alpha/" Enter
tmux_env_python $S 8
tmux_emacs $S 8
