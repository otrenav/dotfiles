...
tmux send-keys -t $S:4 ". ./env/bin/activate" Enter
...
tmux send-keys -t $S:5 ". ./env/bin/activate" Enter
...
tmux send-keys -t $S:6 ". ./env/bin/activate" Enter
...
tmux send-keys -t $S:8 ". ./be/env/bin/activate" Enter
